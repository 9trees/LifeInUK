...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", "lifeinuk.pythonanywhere.com,localhost,127.0.0.1").split(",")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "accounts.context_processors.feedback_unread",
            ],
        },
    },
]
...
# For production, set EMAIL_BACKEND and SMTP vars in .env.
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "Life in the UK Prep <noreply@lifeinuk.pythonanywhere.com>")
